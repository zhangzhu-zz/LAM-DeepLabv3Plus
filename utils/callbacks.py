...
class LossHistory():
    def __init__(self, log_dir, model, input_shape):
        ...
        self.losses     = []
        self.val_loss   = []
        self.total_accuracy = []  # 存储训练准确率
        self.val_accuracy = []    # 存储验证准确率
    ...
    def append_loss(self, epoch, loss, val_loss, total_accuracy, val_accuracy):
        ...
        self.writer.add_scalar('accuracy', total_accuracy, epoch)
    ...
    def loss_plot(self):
        ...
        plt.figure()
        plt.plot(iters, self.losses, 'red', linewidth = 2, label='train accuracy')
        plt.plot(iters, self.val_loss, 'coral', linewidth = 2, label='val accuracy')
        plt.grid(True)
        plt.xlabel('Epoch')
        plt.ylabel('Accuracy')
        plt.legend(loc="upper right")
